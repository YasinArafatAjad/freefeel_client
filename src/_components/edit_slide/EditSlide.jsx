...
import UpdateBanner from '../../pages/DashboardPages/AdminPages/UpdateBanner/UpdateBanner';
...
function EditSlide() {
  ...
  const handleSubmit = useCallback(
    async (e) => {
      ...
      try {
        ...
        const successMessage = res?.data?.message || "🎉 Slideshow configuration saved successfully!";
  ...
  return (<>
    {
      allBanners.length > 0 ? (<UpdateBanner></UpdateBanner>) : (<div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-slate-900 dark:to-gray-900 overflow-hidden">
          {/* Header */}
          <motion.header

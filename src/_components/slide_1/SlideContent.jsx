...
const SlideContent = ({ slide, banner }) => {
...
//   console.log(slideTitle, slideSubtitle, slideDescription);
...
const slideData = {
    0: {
      ...
      buttonText: t("productDetails.shopNowLink")
    },
    1: {
  ...
  return (
    ...
    >
      ...
      {/* Main Heading */}
      <AnimatedText
        text={subtitle[slide] || currentSlide.title}
        delay={0.3}
      ...
      {/* Subheading */}
      <AnimatedText
        text={description[slide] || currentSlide.subtitle}
        delay={0.8}

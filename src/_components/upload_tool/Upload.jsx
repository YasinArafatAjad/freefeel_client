...
import { useCloudinaryLinks } from '../../hooks/useCloudinary/useCloudinaryLinks';
...
function Upload() {
  ...
  const {
    ...
    refetch: refetchCloudinaryLinks,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f4f4f4] via-gray-50 to-[#f4f4f4] dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
              ...
              >
                <Gallery
                  files={cloudinaryLinks.map(file => ({
                    ...
                    resource_type: file.url.match(/\.(mp4|mov|avi|webm)$/i) ? 'video' : 'image', // ✅ Needed for type badge
      ...
      <SuccessNotification isVisible={showSuccess} message={successMessage} onClear={clearSuccess} />
    </div>
  );
}

...
const RefundPolicy = () => {
  ...
  return (
    <div className="bg-gray-100 dark:bg-dark text-light dark:text-dark">
      <Helmet>
        <title>FreeFeel | Refund Policy</title>
        <meta
          name="description"
          content="Explore FreeFeel's Refund Policy to know your rights regarding refunds and returns for a seamless customer experience."
        />
      ...
      <div className="w-full h-full max-w-[100%] sm:max-w-[640px] md:max-w-[768px] lg:max-w-[1024px] xl:max-w-[1280px] 2xl:max-w-[1536px] mx-auto px-2.5 md:px-5 lg:px-0 py-10 lg:py-5 2xl:py-10">
        ...
        <p className="text-[15px] text-light dark:text-dark">{renderDescription(websiteInfo.refundPolicy)}</p>
      </div>
    </div>
  );
};
